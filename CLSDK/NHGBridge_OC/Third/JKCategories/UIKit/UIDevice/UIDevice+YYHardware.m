...
#import "UIDevice+YYHardware.h"

@implementation UIDevice (YYHardware)
...
- (NSString *)modelNameForModelIdentifier:(NSString *)modelIdentifier
{
    ...
    if ([modelIdentifier isEqualToString:@"iPhone12,1"])   return @"iPhone 11";
        ...
        if ([modelIdentifier isEqualToString:@"iPhone12,8"])   return @"iPhone SE 2";
    ...
    if ([modelIdentifier isEqualToString:@"iPad8,9"])      return @"iPad Pro 11 2nd";
        if ([modelIdentifier isEqualToString:@"iPad8,10"])     return @"iPad Pro 11 2nd";
        if ([modelIdentifier isEqualToString:@"iPad8,11"])     return @"iPad Pro 12.9 4th";
        if ([modelIdentifier isEqualToString:@"iPad8,12"])     return @"iPad Pro 12.9 4th";
        if ([modelIdentifier isEqualToString:@"iPad11,1"])     return @"iPad mini 5th";
        if ([modelIdentifier isEqualToString:@"iPad11,2"])     return @"iPad mini 5th";
        if ([modelIdentifier isEqualToString:@"iPad11,3"])     return @"iPad Air 3rd";
        if ([modelIdentifier isEqualToString:@"iPad11,4"])     return @"iPad Air 3rd";
        if ([modelIdentifier isEqualToString:@"iPad11,6"])     return @"iPad 8th";
        if ([modelIdentifier isEqualToString:@"iPad11,7"])     return @"iPad 8th";
        if ([modelIdentifier isEqualToString:@"iPad13,1"])     return @"iPad Air 4th";
        if ([modelIdentifier isEqualToString:@"iPad13,2"])     return @"iPad Air 4th";
    ...
    if ([modelIdentifier isEqualToString:@"iPod9,1"])      return @"iPod touch 7th";
...
- (BOOL)isIphoneXMobile{
    ...
    NSString * deviceName = [self modelName];
    if ([deviceName hasPrefix:@"iPhone X"]) {//刘海屏真机
        return YES;
        
    }else if ([deviceName hasSuffix:@"Simulator"]) {//模拟器
        
        if (@available(iOS 11.0, *) && ([UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom > 0)) {//模拟器带有刘海屏
            return YES;
        }
    }else if ([deviceName hasPrefix:@"iPhone"]) {//普通真机
        return NO;
    }
    return NO;
}
